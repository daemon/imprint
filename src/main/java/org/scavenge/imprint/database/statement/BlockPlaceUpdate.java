...
public class BlockPlaceUpdate extends DatabaseWriteQuery
{
  private BreakEvent _event;
  private static final String _preparedStatementStr = "INSERT INTO imprint.block_places "
      + "(`block_id`, "
      + "player_id, "
      + "`xz`, "
      + "`y`, "
  ...
  public BlockPlaceUpdate(BreakEvent event) throws SQLException
  {
    super();
    this._event = event;
